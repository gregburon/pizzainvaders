...
//  June 8, 2004 All rights reserved.
//
//////////////////////////////////////////////////////////////////////////////
  ...
  extends Goodie
{
  ...
  public LaserGoodie( final int x,
                      final int y,
                      final int deltaX,
                      final int deltaY,
   ...
   */
  public void applyEffectsToPlayer( final PlayerShip player )
  {
    System.err.println( "=== applying laser goodie..." );
    player.incrementFireSpeed();
  }
}
